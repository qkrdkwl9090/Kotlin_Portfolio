...
class SearchHome() : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val textview_address: EditText = findViewById(R.id.addresssearch)
        val ShowLocationButton: LinearLayout = findViewById(R.id.placeSearch)
        ShowLocationButton.setOnClickListener {

            gpsTracker = GpsTracker(this@SearchHome)
            latitude = gpsTracker!!.latitude
            longitude = gpsTracker!!.longitude
            val address: String? = getCurrentAddress(latitude, longitude)

            var simpleAddress: List<String> = address!!.split(" ")
            var addresstext = simpleAddress[1] + " " + simpleAddress[2] + " " + simpleAddress[3]

            val intent = Intent(this@SearchHome, MaskSaleList::class.java)
            intent.putExtra("searchAddress", addresstext)
            Log.d("test1","주소"+addresstext)
            startActivity(intent)
        ...
        if (hasFineLocationPermission == PackageManager.PERMISSION_GRANTED &&
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(
                ...
                ActivityCompat.requestPermissions(
                    this@SearchHome, REQUIRED_PERMISSIONS,
    ...
    private fun showDialogForLocationServiceSetting() {
        val builder: AlertDialog.Builder = AlertDialog.Builder(this@SearchHome)
